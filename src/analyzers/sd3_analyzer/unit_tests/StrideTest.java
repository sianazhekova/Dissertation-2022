...
public class StrideTest {
    ...
    void strideCreation() {
        ...
        testStride1 = new Stride(BigInteger.valueOf(2000), BigInteger.valueOf(-4), BigInteger.valueOf(10), BigInteger.valueOf(11),  new PCPair(BigInteger.valueOf(123456), MemoryAccess.WRITE));
        testStride1.printStrideState();

        Stride testStride2 = new Stride(BigInteger.valueOf(2000), BigInteger.valueOf(-4), BigInteger.valueOf(10), BigInteger.valueOf(11),  new PCPair(BigInteger.valueOf(123456), MemoryAccess.WRITE));
        testStride2.printTestStrideState();
    }

    @TestFactory
    Stream<DynamicTest> testWithinBlock() {
        testStride1 = new Stride(BigInteger.valueOf(1000), BigInteger.valueOf(4), BigInteger.valueOf(TEST_LIMIT), BigInteger.valueOf(15),  new PCPair(BigInteger.valueOf(123456), MemoryAccess.WRITE));
